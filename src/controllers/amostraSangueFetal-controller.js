...
const repository = require('../repositories/amostraSangueFetal-repository');
const AmostraSangueFetal = require('../models/amostraSangueFetal');
const nameModel = 'AmostraSangueFetal';
...
exports.post = async(req, res, next) => {
    try{
        ...
        contract.isRequired(req.body.amostraSangueFetalArray[0].userCadastro, 'O usuário é obrigatório');
...
exports.put = async(req, res, next) => {
    try{
        ...
        const currentObj = new AmostraSangueFetal(getCurrentRecord);
        ...
        if(currentObj.amostraSangueFetalArray.length > 0) {
            ...
            if(currentObj.amostraSangueFetalArray[0].status != 'Cancelado'){
                ...
                var amostraSangueFetal = new AmostraSangueFetal(req.body);
